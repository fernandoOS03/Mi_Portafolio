const INFO = {
  main: {
    ...
    name: "Fernando Olivera Salazar",
    email: "fernando.192023@outlook.es",
    logo: "../logo.jpg",
  },
  ...
  homepage: {
    title: "Desarrollador backend y especialista en automatización web.",
    description:
      "Soy  desarrollador backend con experiencia en Java y Python. Tengo experiencia en el desarrollo de aplicaciones web y en la automatización de tareas y/o procesos utilizando playwright. Me apasiona enfrentar nuevos desafios y mejorar mis habilidades de programación.",
  },
